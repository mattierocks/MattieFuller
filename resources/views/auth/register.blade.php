...
<div class="columns">
        <div class="column is-one-third is-offset-one-third m-t-100">
                ...
                <div class="card-content">
                    ...
                    <form action="{{ route('register') }}" method="POST" role="form">
                        ...
                        <div class="field">
                            ...
                            <p class="control">
                                <input class="input {{$errors->has('name') ? 'is-danger' : ''}}" type="text" name="name" id="name" placeholder="name@example.com" value="{{ old('email') }}" required>
                            </p>
                            @if ($errors->has('name'))
            ...
            <h5 class="has-text-centered m-t-10"><a href="{{ route('login') }}" class="is-muted">Already Registered?</a></h5>
        </div>
    </div>
