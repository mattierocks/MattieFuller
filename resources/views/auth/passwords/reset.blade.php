...
<div class="columns">
        <div class="column is-one-third is-offset-one-third m-t-100">
                            ...
                            <div class="columns">
                                    <div class="column">
                                        <div class="field">
                                            ...
                                            <p class="control">
                                                <input class="input {{$errors->has('password_confirmation') ? 'is-danger' : ''}}" type="password" name="password" id="password-confirmation" required>
                                            </p>
            ...
            <h5 class="has-text-centered m-t-10"><a href="{{ route('password.request') }}" class="is-muted"><i class="fa fa-caret-left">Back To Login</i></a></h5>
        </div>
    </div>
@endsection
